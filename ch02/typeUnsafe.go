...
func main() {
	...
	fmt.Printf("myByteSlice: %p\n", myByteSlice)
	fmt.Printf("myByteSlice: %p\n", unsafe.SliceData(myByteSlice))
	...
	myByteSlice2 := stringToByte(myStr)
	fmt.Printf("myByteSlice2 type: %T\n", myByteSlice2)
	fmt.Printf("myByteSlice2: %p\n", unsafe.SliceData(myByteSlice2))
}
